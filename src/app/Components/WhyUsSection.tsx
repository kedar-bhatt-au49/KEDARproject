              ...
              <div className="absolute -top-10 right-0 w-[400px] h-[500px] z-20 hidden md:block overflow-hidden rounded-xl group">
                <div className="bg-gray-100 rounded-xl p-8 shadow-lg h-full cursor-pointer transition-all duration-300 hover:border-2 hover:border-black">
                  <div className="text-black space-y-6">
                    ...
                    <p className="text-lg font-medium">
                      Quality first: We are obsessed with exceeding your expectations. Every project gets our full attention and a customized approach, from research to launch and beyond.
                    </p>
                    <p className="text-lg font-medium">
                    Your success is our mission: We dont just build software, we build partnerships.
                    </p>
                  </div>
                </div>
              </div>
